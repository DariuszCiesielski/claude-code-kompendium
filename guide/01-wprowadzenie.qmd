...
::: {.callout-tip}
## Pierwszy krok po instalacji
Po zainstalowaniu Claude Code, wejdź do katalogu dowolnego projektu i uruchom `claude`. Narzędzie automatycznie przeanalizuje strukturę projektu i będzie gotowe do pracy. Nie musisz konfigurować niczego na start — Claude Code sam wykryje technologie, framework i konwencje.
:::
...
[Rozdział 2: Podstawowe komendy →](02-podstawowe-komendy.qmd)
