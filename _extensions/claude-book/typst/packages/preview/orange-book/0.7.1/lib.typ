  ...
  [
    ...
    #context{
      ...
      if part-style == 0 [
        ...
        #v(4cm)
        #align(center)[
          #text(fill: main-color, size: 1.5em, weight: "bold")[#supplement_part #part-counter.display("I")]
          #v(1cm, weak: true)
          #text(fill: black, size: 2.5em, weight: "bold")[#part-state.get()]
        ]
        #v(2cm)
