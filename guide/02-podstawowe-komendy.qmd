...
::: {.callout-important}
## Kluczowa zasada
Opisuj problem, nie rozwiązanie. Claude Code sam dobierze najlepsze narzędzia i podejście. Im więcej kontekstu biznesowego podasz, tym lepszy wynik dostaniesz.
:::
...
::: {.callout-tip}
## Wzorzec złotej ścieżki
Zacznij od prostego polecenia, oceń wynik, doprecyzuj. Iteracja jest tańsza niż próba opisania idealnego wyniku za jednym razem.
:::

## Następny rozdział

[← Rozdział 1: Wprowadzenie](01-wprowadzenie.qmd) | [Rozdział 3: System skilli →](03-system-skilli.qmd)
