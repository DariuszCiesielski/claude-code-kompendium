...
::: {.callout-important}
## CLAUDE.md to Twoja „instrukcja obsługi" projektu
Claude czyta ten plik na starcie każdej sesji. Wszystko czego Claude ma się trzymać — konwencje, stack, ograniczenia — zapisz tutaj. Nie polegaj na pamięci sesji.
:::
...
::: {.callout-tip}
## Zasada: MEMORY.md > powtarzanie
Zamiast tłumaczyć te same decyzje w każdej sesji, zapisuj je w plikach memory. Claude przeczyta je automatycznie i nie będziesz musiał się powtarzać.
:::
...
flowchart TD
    ...
    A --> C["Memory files\n(persystentne)"]
    A --> D["Handoffs\n(transfer kontekstu)"]
    B --> E["Czytane na starcie\nkażdej sesji"]
    C --> F["Zapamiętane\nmiędzy sesjami"]
    D --> G["Kontynuacja pracy\npo przerwie"]
```
